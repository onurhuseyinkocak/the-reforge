    ...
    <div className="min-h-screen bg-[#0A1628] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-[#F0F4F8]/60">Hesabına giriş yap</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-[#0D1B2A] border border-white/10 rounded-xl p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative mt-1">
              <Input
                ...
                className="bg-[#0A1628] border-white/10 text-white pr-10"
                placeholder="••••••••"
              />
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-xs text-[#00A3FF] hover:underline">Şifremi unuttum</Link>
          </div>
        ...
        <p className="text-center mt-4 text-sm text-[#F0F4F8]/50">
          Hesabın yok mu?{" "}
          <Link to="/register" className="text-[#00A3FF] hover:underline">Kayıt ol</Link>
        </p>
      </div>
    </div>
  );
